...
contract Election {
    ...
    string[] candidateList = ["Trupti","Tanvi","Shweta","Aishu"];
    ...
    function andData(uint256 age, uint256 criminalCase, uint256 qualification) private {
    ...
    function candidateDatas() public view returns (uint256[][] memory){
